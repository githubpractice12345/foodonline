...
from .utils import generate_order_number, total_order_by_vendor
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' and request.method == 'POST':
        ...
        for i in cart_items:
            if i.fooditem.vendor.user.email not in to_emails:
                ...
                ordered_food_to_vendor = OrderedFood.objects.filter(order=order, fooditem__vendor=i.fooditem.vendor) #gives vendor specific ordered food.
        ...
        # print('to_emails=>', to_emails)
                context = {
                    ...
                    'vendor_subtotal': total_order_by_vendor(order, i.fooditem.vendor.id)['subtotal'],
                    'tax_data': total_order_by_vendor(order, i.fooditem.vendor.id)['tax_dict'],
                    'vendor_grand_total': total_order_by_vendor(order, i.fooditem.vendor.id)['grand_total'],
